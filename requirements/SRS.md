...
*   Окно корзины с выбранными товарами.
*   Окно оформления заказа с формой для ввода данных.
*   Окно отслеживания статуса заказа.
*   Окно личного кабинета с историей заказов.
